...
public class InvestigationController {
    ...
    public CorrectionResponse approveCorrection(
        ...
        return CorrectionResponse.from(correctionPublicationService.approve(
                workspaceId, caseId, correctionId, request.goldBaselineRunId(), request.goldCandidateRunId(), request.ragBaselineRunId(), request.ragCandidateRunId()));
    }
    ...
    public record CorrectionApprovalRequest(
            @NotNull UUID goldBaselineRunId,
            @NotNull UUID goldCandidateRunId,
            @NotNull UUID ragBaselineRunId,
            @NotNull UUID ragCandidateRunId) {
    }
